...
((FamilyTree._defaultConfig = function (e) {
                    ...
                    function (e) {
                        if (!a.notifierUI.show(e.notif)) {
                            ...
                            var s = a.getViewBox(),
                                d = e.viewBox;
                            n = { content: o, res: e };
                            (FamilyTree.events.publish('prerender', [a, n]),
                                (o = n.content));
                            var c = [];
                            if (FamilyTree.RENDER_LINKS_BEFORE_NODES)
                                for (
                                    var m = 0;
                                    m < e.visibleNodeIds.length;
                                    m++
                                ) {
                            ...
                            if (
                                ...
                                : (
                                    ...
                                    (y ||
                                        (r && r(),
                                        FamilyTree.events.publish('redraw', [
                                            a,
                                        ]),
                                        (y = !0)))
                                :   FamilyTree.animate(
        ...
        if (null != r) {
            ...
            if (null != a) {
                ...
                (FamilyTree.events.publish('ripple', [this, T]),
                    ...
                    y.setAttribute(
                        'width',
                        T.ripple.rect ? T.ripple.rect.width : r.w,
                    ),
                    y.setAttribute(
                        'height',
                        T.ripple.rect ? T.ripple.rect.height : r.h,
                    ),
        ...
        if (y - 2 * this.config.padding >= n - l) v = (n + l) / 2 - y / 2;
            ...
            switch (
                ((v =
                    firstRoot.x -
                    y / 2 +
                    FamilyTree.manager._getNodeWidth(firstRoot, this.config) /
                        2),
                this.config.orientation)
            ) {
            ...
            switch (
                ...
                case FamilyTree.orientation.right:
                    T =
                        firstRoot.y -
                        g / 2 +
                        FamilyTree.manager._getNodeWidth(
                            firstRoot,
                            this.config,
                        ) /
                            2;
    ...
    (FamilyTree.anim.inOutBack = function (e) {
        return (
            e < 0 ? 0
            : e > 1 ? 1
            : e < 0.5 ? 4 * e * e * (7.1898 * e - 2.5949) * 0.5
            : 0.5 *
                ((2 * e - 2) * (2 * e - 2) * (3.5949 * (2 * e - 2) + 2.5949) +
                    2)
        );
    }),
                ...
                (s = f[u]).addEventListener('click', function (e) {
                    ...
                    if (void 0 === a[o].onClick)
                        if ('add' === o) {
                            ...
                            'remove' === o ? n.obj.removeNode(i, null, !0)
                            : 'svg' === o ?
                                n.obj.exportSVG({
                            ...
                            : 'csv' === o ? n.obj.exportCSV({ nodeId: i })
                            : 'xml' === o ? n.obj.exportXML({ nodeId: i })
    ...
    (FamilyTree._getTags = function (e) {
        return (
            e.tags && !Array.isArray(e.tags) ? e.tags.split(',')
    ...
    (FamilyTree._getClientXY = function (e) {
        return (
            -1 == e.type.indexOf('touch') ? { x: e.clientX, y: e.clientY }
    ...
    (FamilyTree.wrapText = function (e, t) {
        ...
        if (-1 != m.indexOf('multiline')) {
            ...
            for (var F = 1, x = !1, _ = 1; _ < g.length; _++) {
                ...
                if (
                    ((T.firstChild.data += ' ' + g[_]),
                    T.getComputedTextLength() > c)
                ) {
                    if (
            ...
            if (null != p.innerHTML) ((S = p.innerHTML), (p.innerHTML = ''));
                ...
                for (_ = p.childNodes.length - 1; _ >= 0; _--)
                    ((C =
                        XMLSerializer().serializeToString(p.childNodes[_]) + C),
        ...
        for (var o = 0; o < n; o++)
            !(function () {
                ...
                FamilyTree._getDataUri(t.getAttribute(i), function (a) {
                    (a.success && t.setAttribute(i, a.result),
                        e == n - 1 && r());
                });
            })();
    }),
    ...
    (FamilyTree._convertStringToArray = function (e, t) {
        return (
            -1 != FamilyTree.ARRAY_FIELDS.indexOf(e) ?
                FamilyTree.isNEU(t) ?
                    []
                :   t.split(',')
            :   t
    ...
    (FamilyTree._getScrollSensitivity = function () {
        ...
        return (
            e.msie && FamilyTree.scroll.ie ? FamilyTree.scroll.ie
            : e.edge && FamilyTree.scroll.edge ? FamilyTree.scroll.edge
            : e.safari && FamilyTree.scroll.safari ? FamilyTree.scroll.safari
            : e.chrome && FamilyTree.scroll.chrome ? FamilyTree.scroll.chrome
            : e.firefox && FamilyTree.scroll.firefox ? FamilyTree.scroll.firefox
            : e.opera && FamilyTree.scroll.opera ? FamilyTree.scroll.opera
            : {
    ...
    (FamilyTree.isObject = function (e) {
        return (
            ...
            null !== e &&
            e.constructor &&
            'object' == e.constructor.name.toLowerCase()
        );
    }),
    void 0 === FamilyTree && (FamilyTree = {}),
    (FamilyTree.icon = {}),
    ...
    (FamilyTree.prototype._defaultExportOptions = function (e, t) {
        return (
            null == e && (e = {}),
            'svg' == t ? ((e.ext = 'svg'), (e.mime = 'image/svg+xml'))
            : 'pdf' == t ? ((e.mime = 'application/pdf'), (e.ext = 'pdf'))
            ...
            this._draw(!1, FamilyTree.action.exporting, r, function (r, a) {
                ...
                if ('svg' == e.ext)
                    if (t) t(e, n.innerHTML);
                        ...
                        (o = n.querySelector('svg')).classList.add(
                            'bft-' + i.config.mode,
                        );
                        var s = {
                                content: n.innerHTML,
                            ...
                            d = FamilyTree.events.publish('exportstart', [
                                i,
                                s,
                            ]),
                        ...
                        if (
                            !1 ===
                            (d = FamilyTree.events.publish('exportend', [i, s]))
                        )
                            return !1;
    ...
    (FamilyTree.prototype.exportCSV = function (e) {
        var t = FamilyTree._defaultExportProfileOptionsForCSV_SVG_JSON(
            ...
            r = null;
        i ? ((r = []), FamilyTree._exportIterateForJSON_XML_CSV(this, i, t, r))
        ...
        if (!FamilyTree.EXPORT_PAGES_CUT_NODES && 'fit' == e.scale) {
            ...
            for (
                ...
                F < Object.keys(r.bordersByRootIdAndLevel[T[x]]).length &&
                    ((b = r.bordersByRootIdAndLevel[T[x]]),
                    (F = Object.keys(b).length));
            for (var _ = 0, w = 0; ; ) {
                for (w = _; !(F <= _); ) {
                ...
                if (e[t]) {
                    ...
                    if (r.length > 0) {
                        ...
                        for (
                            a = 0;
                            a < r.length &&
                            (1 == i.length ? (o = r[a](i[0]) && o)
                            : 2 == i.length ? (o = r[a](i[0], i[1]) && o)
                            : 3 == i.length ? (o = r[a](i[0], i[1], i[2]) && o)
                            : 4 == i.length ?
    ...
    (FamilyTree.prototype._movableHandler = function (e, t, i) {
        var r = this,
            ...
            o = function (e, t) {
                if (Array.isArray(e))
                    for (var i = 0; i < e.length; i++) o(e[i], t);
                else {
                    t.push(e.id);
                    for (i = 0; i < e.stChildren.length; i++)
                        o(e.stChildren[i], t);
        ...
        var C = { x: c.x, y: c.y },
            ...
            N = function (e, t) {
                if (null != e) {
                    ...
                    for (
                        var i = r.getNode(k),
                            a = FamilyTree.getStParentNodes(i),
                            n = 0;
                        n < a.length;
                        n++
                    ) {
            ...
            A = function (t) {
                if (C) {
                    var i = FamilyTree._getClientXY(t),
                        o = t.target;
                    FamilyTree.isMobile() &&
                        (o = document.elementFromPoint(i.x, i.y));
                    ...
                    if (c.left || c.right || c.up || c.down) {
                        ...
                        if (
                            ...
                            for (; null != o && o != d; ) {
                                if (
                                    o.hasAttribute &&
                                    o.hasAttribute(FamilyTree.attr.node_id)
                                ) {
                                    var O = o.getAttribute(
                                        FamilyTree.attr.node_id,
                                    );
                                    if (
                                        r._gragStartedId &&
                        ...
                        if (null != k) {
                            ...
                            for (
                                var U = r.getNode(k),
                                    B = FamilyTree.getStParentNodes(U),
                                    R = 0;
                                R < B.length;
                                R++
                            ) {
            ...
            L = function (t) {
                ...
                if (
                    ...
                    if (
                        !1 ===
                        (o = FamilyTree.events.publish('drop', [
                            r,
                            m[0].id,
                            n.id,
                            u[0],
                    ...
                    if (e._dragEventFired) {
                        ...
                        if (r.config.movable && !1 !== o)
                            if (
                                ...
                                var c = FamilyTree._getTransform(
                                    r.getNodeElement(s.id),
                                );
                                ...
                                (FamilyTree.events.publish('updated', [r]),
                                    r.draw(FamilyTree.action.update, {
                                        dragNodeIdList: h,
                                    }));
                            }
                    }
                ...
                if (c) {
                    ...
                    if (g.left || g.right || g.up || g.down) {
                        ...
                        if (
                            ...
                            (!1 ===
                                FamilyTree.events.publish('drag', [s, k, t]) &&
                                v(),
                                (e._dragEventFired = !0));
                        u.setAttribute(
                            'transform',
    ...
    (FamilyTree.searchUI.prototype.init = function (e) {
        ...
        (this.instance.element.insertBefore(l, d),
            ...
            this.input.addEventListener('keyup', function (e) {
                'ArrowDown' == e.key ? c()
                : 'ArrowUp' == e.key ? m()
                : 'Enter' == e.key ? t._enterHandler()
                : 'Escape' == e.key ? t.hide()
                : this.value.length >=
                        FamilyTree.MINIMUM_SYMBOLS_IN_SEARCH_INPUT &&
                    t._search();
            }));
        var c = function () {
        ...
        if (null == this.instance.config.searchFields) {
            ...
            for (var e = 0; e < this.instance.response.allFields.length; e++) {
                ...
                'tags' == t ||
                    ...
                    (-1 == this._searchFields.indexOf(t) &&
        ...
        if (
            ...
            if (
                ...
                for (
                    ...
                    (
                        -1 ==
                            (g = t.parent.children[y]).tags.indexOf(
                                'partner',
                            ) &&
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
        for (
            ...
            var m,
                h = d[c];
            ((m =
                FamilyTree.STRING_TAGS ?
                    h.tags ?
                        h.tags.split(',')
                    :   []
                : Array.isArray(h.tags) ? h.tags.slice(0)
                : []),
    ...
    (FamilyTree.manager._createNodes = function (e) {
                ...
                if (m) {
                    ...
                    if (!f) {
                        if (!FamilyTree.isNEU(m.pid))
                            (ue = (v = l[m.pid]).childrenIds.indexOf(m.id)) >
                                -1 && v.childrenIds.splice(ue, 1);
                        s.push(m);
                    }
                }
            }
            ...
            for (var T = l[a.id]; T; ) {
                if (
                    ...
                    a.options.parentState ===
                        FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T)
                )
        ...
        for (c = 0; c < S.length; c++) {
            ...
            for (b = 0; b < g.children.length; b++) {
                (D = g.children[b]).isAssistant ? C.push(D.id)
            ...
            for (b = 0; b < I.length; b++) {
                ...
                for (var R = 0; R < D.childrenIds.length; R++)
                    B.push(D.childrenIds[R]);
            }
            var P = [];
            for (b = 0; b < N.length; b++) {
                A[(D = l[N[b]]).id] ?
                    g.children.push(D)
                :   g.children.splice(0, 0, D);
                for (R = 0; R < D.childrenIds.length; R++)
                    P.push(D.childrenIds[R]);
            }
        ...
        for (c = 0; c < w.length; c++) {
            ...
            for (b = 0; b < g.subLevels; b++) {
                ...
                if (
                    (FamilyTree.manager._initDinamicNode(z, g.lcn),
                    (v = g.parent))
                )
            ...
            for (var $ in k) {
                ...
                if (0 != (H = i[v.lcn ? v.lcn : 'base']).layout || ee) {
                    ...
                    for (var he = 0; he < te.layouts.length; he++) {
                        ...
                        for (
                            FamilyTree.isNEU(pe.subLevels) &&
                                (pe.subLevels = 0),
                                FamilyTree.isNEU(pe.layout) &&
                                    (pe.layout = H.layout),
                                me = v = l[$];
                            me.isSplit;
                        )
                        ...
                        if (pe.subLevels) {
                            for (b = 0; b < pe.childrenIds.length; b++) {
                                ...
                                (-1 != (ue = v.children.indexOf(D)) &&
                                    v.children.splice(ue, 1),
                                    (D.parent = fe),
                                    fe.children.push(D));
                            }
                            v = fe;
                        ...
                        if (
                            ...
                            'dynamic' == pe.layoutGridColumns &&
                                (pe.layoutGridColumns =
                                    FamilyTree._getDynamicGridCoulumns(
                            ...
                            for (c = 0; c < pe.childrenIds.length; c += ge) {
                                ...
                                for (b = 0; b < ge; b++) {
                                    ...
                                    if (pe.childrenIds.length - 1 < c + b)
                                        break;
                                    (((D =
                                        l[
                                            (de = pe.childrenIds[c + b])
                                        ]).parent = l[ye]),
    ...
    (FamilyTree.manager._getResponse = function (
        ...
        if (
            ...
            if (
                ...
                ((C = h[m.id]),
                    (C = FamilyTree.manager._getMostDeepChild(C, h)));
        ...
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            ...
            if (null != c && null != c.x && null != c.y)
                if (c.x != e.x || c.y != e.y)
                    (n &&
                        n.dragNodeIdList &&
                        -1 != n.dragNodeIdList.indexOf(e.id)) ||
                        (d[0].push(e.id),
            ...
            for (var i = [], r = 0; r < e.groupDottedLines.length; r++) {
                ...
                if (!i.has(n))
                    for (var o = 0; o < t.length; o++)
                        if (t[o].id == a.rootId) {
                            (((c = JSON.parse(JSON.stringify(t[o]))).id =
                                `balkan_group_dotted_${a.rootId}_balkan_id_${t[o].id}`),
                                (c.pid = void 0),
                                (c.stpid = t[o].id),
                                t.push(c),
                                i.push(n),
            ...
            for (r = 0; r < e.dottedLines.length; r++) {
                ...
                for (o = 0; o < t.length; o++)
                    if (t[o].id == d.from) {
                        ...
                        if (
                            (((c = JSON.parse(JSON.stringify(t[o]))).id =
                                `balkan_dotted_${d.rootId}_balkan_id_${t[o].id}`),
                            d.rootId == d.to ?
                                (c.pid = d.to)
            ...
            ((p =
                FamilyTree.STRING_TAGS ?
                    f.tags ?
                        f.tags.split(',')
                    :   []
                : Array.isArray(f.tags) ? f.tags.slice(0)
                : []),
            ...
            if (g) {
                ...
                if (
                    ...
                    l && m && v && l.id == c.id ?
                        ...
                        : (
                            (v.hasPartners && 2 == m.isPartner) ||
                            1 == m.isPartner
                        ) ?
                            g.tags.push('right-partner')
                        : 2 == m.isPartner ? g.tags.push('left-partner')
                        : g.tags.push('partner')
                    : v && 2 == v.isPartner ? g.tags.push('left-partner')
                    : v && 1 == v.isPartner ? g.tags.push('right-partner')
                    : g.tags.push('partner'),
    ...
    (FamilyTree.templates.base = {
        ...
        svg: '<svg class="{randId} {template} {mode}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
        link: '<path stroke-linejoin="round" stroke="{linkColor}" stroke-width="1px" fill="none" d="{rounded}" />',
        assistanseLink:
            '<path stroke-linejoin="round" stroke="{linkColor}" stroke-width="2px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} {xd},{yd} L{xe},{ye}"/>',
        pointer:
    ...
    (FamilyTree.templates.simple = Object.assign(
        {},
        FamilyTree.templates.base,
    )),
    (FamilyTree.templates.simple.size = [260, 32]),
    (FamilyTree.templates.simple.padding = [6, 8, 6, 8]),
    (FamilyTree.templates.simple.defs = `<style>
                .{randId} text{font-size:500px;font-weight:800;fill:#000;dominant-baseline:middle}
                .{randId}.dark text{fill:#ffffff}
                .{randId} .male text{fill:#039BE5}
                .{randId} .female text{fill:#F57C00}
            </style>`),
    (FamilyTree.templates.simple.node = ''),
    (FamilyTree.templates.simple.field_0 =
        '<text ' +
        FamilyTree.attr.width +
        '="160" x="{cw}" y="18" text-anchor="middle">{val}</text>'),
    (FamilyTree.templates.simple.img_0 = ''),
    (FamilyTree.templates.simple.field_1 = ''),
    (FamilyTree.templates.simple_male = Object.assign(
        {},
        FamilyTree.templates.simple,
    )),
    (FamilyTree.templates.simple_female = Object.assign(
        {},
        FamilyTree.templates.simple,
    )),
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, o, l, s, d) {
            ...
            // add gender class based on bound data (t)
            try {
                if (t && t.gender) {
                    var _g = String(t.gender).toLowerCase();
                    if ('male' === _g) b += ' male';
                    else if ('female' === _g) b += ' female';
                }
            } catch (ex) {}
            var F = '';
            e.lcn && (F = 'lcn="' + e.lcn + '"');
        ...
        link: function (e, t, i, r, a, n, o) {
                ...
                for (var g = 0; g < e.children.length; g++) {
                    (T = e.children[g]).parentPartner ?
                        ...
                        1 == T.parentPartner.isPartner ?
                            ...
                            (y.indexes[T.id] = y.rightIds.indexOf(
                                T.parentPartner.id,
                            )),
                        ...
                        :   2 == T.parentPartner.isPartner &&
                            ...
                            (y.indexes[T.id] = y.leftIds.indexOf(
                                T.parentPartner.id,
                            )),
                            (y.lastLeft = T)))
                    :   T.isPartner ||
            ...
            for (g = 0; g < e.children.length; g++) {
                ...
                // replace link color placeholder based on theme (light/dark)
                x = x.replaceAll(
                    '{linkColor}',
                    t && t.config && t.config.mode === 'dark' ?
                        '#ffffff'
                    :   '#000000',
                );
                    ...
                    switch (s.orientation) {
                        ...
                        case FamilyTree.orientation.top_left:
                            var _ =
                                1 == T.layout ?
                                    void 0
                                :   b.minY - (b.minY - u.maxY) / 2;
                            F = FamilyTree.ui._linkTopToBottom(
                                T.parentPartner,
                                T,
                                d,
                                h,
                        ...
                        case FamilyTree.orientation.bottom_left:
                            _ =
                                1 == T.layout ?
                                    void 0
                                :   b.maxY - (b.maxY - u.minY) / 2;
                            F = FamilyTree.ui._linkBottomToTop(
                                T.parentPartner,
                                T,
                                d,
                                h,
                        ...
                        case FamilyTree.orientation.right_top:
                            _ =
                                1 == T.layout ?
                                    void 0
                                :   b.maxX - (b.maxX - u.minX) / 2;
                            F = FamilyTree.ui._linkRightToLeft(
                                T.parentPartner,
                                T,
                                d,
                                h,
                        ...
                        case FamilyTree.orientation.left_top:
                            _ =
                                1 == T.layout ?
                                    void 0
                                :   b.minX - (b.minX - u.maxX) / 2;
                            F = FamilyTree.ui._linkLeftToRight(
                                T.parentPartner,
                                T,
                                d,
                                h,
                ...
                var S = FamilyTree.ui._draggableLinkPath(
                    t,
                    e,
                    T,
                    F,
        ...
        if (this.bar) {
            ...
            ((this.bar.ignore = !0),
                ...
                FamilyTree.events.publish('change', [
                    ...
                    {
                        isScrollBarVisible:
                            'hidden' != this.bar.style.visibility,
                    },
                ]));
        }
    }),
        ...
        if (e instanceof FamilyTree && e.config.movable && r)
            for (var a = 0; a < r.length; a++) {
                ...
                for (s = 0; s < l.length; s++)
                    l[s].parentNode.removeChild(l[s]);
            }
    }),
    (FamilyTree.prototype._clink = function (e, t) {
        for (var i = '', r = 0; r < this.config.clinks.length; r++) {
            ...
            function _(e, t, i) {
                ...
                return (
                    (o =
                        (o / (Math.sqrt(r * r + n * n) * i)) *
                        FamilyTree.clinkCurve(a)),
                ...
                for (; null == d; ) {
                    ...
                    if (
                        ...
                        :   FamilyTree._intersects(T, u, h) &&
                            ((u = FamilyTree._addPoint(T, s, h, u, c)),
                            (v = !0)),
                        T.id != n.id)
                    ) {
                        for (; b; ) {
                            ...
                            (FamilyTree._intersects(b, u, h) &&
                                ((u = FamilyTree._addPoint(b, s, h, u, c)),
                                (v = !0)),
                                (b = b.leftNeighbor));
                        }
                        for (; F; ) {
                            ...
                            (FamilyTree._intersects(F, u, h) &&
                                ((u = FamilyTree._addPoint(F, s, h, u, c)),
                                (v = !0)),
                                (F = F.rightNeighbor));
                        }
                    }
                    ...
                    (l.onclick = function (t) {
                        if (
                            ...
                            var r = l.getBoundingClientRect(),
                                a = r.left,
                                s = r.top;
                            ((n = parseInt(t.clientX - a)),
                                (o = parseInt(t.clientY - s)));
    ...
    (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
        ...
        for (p = n.length - 1; p >= 0; p--)
            for (m = 0; m < n.length; m++)
                m < p &&
                    n[m].start + n[m].length > n[p].start &&
                    n.splice(p, 1);
        var T = t;
        for (p = n.length - 1; p >= 0; p--)
    ...
    (FamilyTree._search.searchIndexesOf = function (e, t) {
        ...
        return (
            i.sort(function (e, t) {
                return (
                    e.length < t.length ? 1
                    : e.length > t.length || e.start < t.start ? -1
                    : e.start > t.start ? 1
                    : 0
                );
            }),
        ...
        if (e) {
            ...
            e.readFromIndexedDB &&
                FamilyTree.idb.read(e.name, function (a, n) {
                    if (0 == a)
                        (console.error('Cannot read from - ' + e.name),
                            r(null));
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        if (v.length) {
            ...
            ('male' == c.gender ?
                ((T.templateName = 'wife'),
                (T._ft_partnerData.gender = 'female'))
            :   'female' == c.gender &&
                ((T.templateName = 'husband'),
                (T._ft_partnerData.gender = 'male')),
                c.pids.push(T.id),
                m.push(T));
        }
    ...
    (FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            for (var s in this.filterBy) {
                ...
                (FamilyTree.events.publish('add-filter', [p, u]),
                    (f += u.html));
            }
                    ...
                    if (
                        ...
                        for (
                            var t = e.target.getAttribute('data-filter-field'),
                                i =
                                    p.instance.element.querySelectorAll(
                                        '[data-filter-menu]',
                                    ),
                                r = 0;
                            r < i.length;
                        ...
                        var n = p.instance.element.querySelector(
                            '[data-filter-close]',
                        );
                        if (
